...
class Character(pygame.sprite.Sprite):
    ...
    def update_animation(self):
        if self.is_dead:
            ...
            anim_speed = 0.25 if self.is_attacking else 0.18
...
async def main():
    ...
    p2_pre_soldier = Soldier(600, 150)
    p2_pre_orc = Orc(600, 150)
    ...
    while run:
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if game_state == STATE_MENU:
                    ...
                    if event.key == pygame.K_RETURN:
                        if menu_index == 0: game_mode = "single"; game_state = STATE_CHAR_SELECT
                        if menu_index == 1: game_mode = "multi"; game_state = STATE_CHAR_SELECT
                        if menu_index == 2: run = False
        ...
        if game_state == STATE_MENU:
            ...
            label = font_main.render("SELECT: [A/D] for P1, [Arrows] for P2, [ENTER] Start", True, (255, 255, 255))
            ...
            screen.blit(p1_v.image, (150, 150))
            screen.blit(p2_v.image, (600, 150))
